...
\begin{enumerate}
  ...
  \item The minimum number of members required to exceed 50\% of the total membership. % Changed from 'Two persons entitled to vote on the business to be transacted (each being a member, a proxy for a member or a duly Authorised Representative of a member); or 10\% of the total membership (represented in person or by proxy), whichever is greater, shall be a quorum.'
...
\begin{enumerate}
  ...
  \item A person who is not a member of the Company shall not have any right to vote at a general meeting of the Company; but this is without prejudice to any right to vote on a resolution affecting the rights attached to a class of the Company’s debentures. % Mandatory provision
